...
* Josh Davenport
*
* Resets a forgotten password by sending a password reset
* confirmation email to users registered email account.
* Password can then be reset from a web browser.
* Authentication password is also updated in Firebase.
* */
...
public class ResetPassword extends UncaughtExceptionActivity {
