 ...
 *
 * Rick Cantu
 * Pop-up dialog for setting what circles to display
 *
 */
...
public class setDisplayCircle extends DialogFragment {
    ...
    public  View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        try {
            ...
            view = inflater.inflate(R.layout.dialog_displaycircle, container);

            // Button to add the contact to the specified circle.
            final Button setVisibilityButton = (Button) view.findViewById(R.id.close_display_button);

            // Spinner to select what circle the user will be placed in.
            Spinner spinner = (Spinner) view.findViewById(R.id.display_spinner);
